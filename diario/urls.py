...
urlpatterns = [
    ...
    path('api/diario/tarefas-futuras/', views.UtilidadeTarefas.definir_tarefas_futuras, name='definir_tarefas_futuras'),
    path('api/diario/consultar-tarefas/', views.UtilidadeTarefas.consultar_tarefas, name='consultar_tarefas'),
    path('api/diario/metricas/', views.UtilidadeTarefas.metricas_tarefas, name='metricas_tarefa'),
]
